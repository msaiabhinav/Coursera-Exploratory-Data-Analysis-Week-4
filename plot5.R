...
class_code <- readRDS ( "Source_Classification_Code.rds" )
                                                        ...
                                                        ## subset data from Baltimore City from the type "ON ROAD"
...
## creating a plot showing car related emissions in Baltimore City between 1999 and 2008
png(filename = "plot5.png") ## title
#plotting and labelling X and Y
